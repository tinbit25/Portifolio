          ...
          <div className="lg:flex justify-between ">
            ...
            <div className="section-header p-4">
              ...
              <h2 className="text-display-title text-7xl font-bold font-serif">
                Empowering Change Through Code: Tinbite Elias – A Visionary Developer on a Mission to Innovate and Inspire
              </h2>
              <div className="lg:w-1/3">
                <div className="s-about__content-btn mt-8">
                  ...
                  <ul className="s-about__social social-list flex mt-4 justify-center lg:justify-start">
                    <li className="mx-2">
                      <a href="https://github.com/Tinbit25" aria-label="GitHub" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">
                      <FontAwesomeIcon icon={faGithub} className="text-gray-400 hover:text-black" />
                      </a>
                    </li>
                    <li className="mx-2">
                      <a href="https://www.linkedin.com/in/tinbite-elias-40409a317?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer"className="hover:text-blue-400">
            ...
            <div className="s-about__content-main mt-6">
              <p className="attention-getter text-lg ">
                As a dedicated software engineering student, I am passionately pursuing my goal of becoming a full-stack developer. Currently, I am honing my skills as a frontend developer while also delving into backend technologies. This journey is fueled by my desire to create impactful web applications that address both local and global challenges.
              </p>
              ...
              <p className="attention-getter text-lg mt-4">
                With a strong foundation in frontend development and a growing knowledge of backend systems, I am on a path to becoming a versatile and skilled full-stack developer. My ultimate goal is to leverage my abilities to build applications that make a meaningful difference in our society.
              </p>
            </div>
