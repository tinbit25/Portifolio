...
<div className=" logo"> 
  ...
  <ul className={`space-y-1 ${isOpen ? 'block' : 'hidden'} md:flex flex-col md:space-y-0 md:space-x-4`}>
    <li><Link to="/" className="nav-link flex items-center ml-4"><FontAwesomeIcon icon={faHome} className="mr-2" /> Home</Link></li>
